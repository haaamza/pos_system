...
<head>
    ...
    <title><?php echo $title ?> | Mian Oil Gallery</title>
                        ...
                        <div class="d-flex m-t-10 justify-content-end">
                            <div class="d-flex m-r-20 m-l-10 hidden-md-down">
                                <div class="chart-text m-r-10">
                                    ...
                                    <h4 class="m-t-0 text-info"><span>RS </span><span class="lblMonthSales"></span></h4></div>
                            ...
                            <div class="d-flex m-r-20 m-l-10 hidden-md-down">
                                <div class="chart-text m-r-10">
                                    ...
                                    <h4 class="m-t-0 text-primary"><span>RS </span><span class="lblLastMonthSales"></span></h4></div>
                                <div class="spark-chart">
