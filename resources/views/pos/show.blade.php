...
<head>
    ...
    <title>POS | Mian Oil Gallery</title>
        ...
        <div class="container">
            <div class="mb-3">
                <div class="row justify-content-between">
                    <div class="col-md-12 p-5 printableAreaR">
                            <h1>Mian Oil Gallery</h1><br>
                        ...
                        <div class="row">
                                ...
                                <div class="table-responsive m-t-40" style="clear:both">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right">Unit Cost (<span >RS </span>)</th>
                                            <th class="text-right">Total (<span >RS </span>)</th>
                                        </tr>
                                        </thead>
                            ...
                            <div class="col-md-12">
                                <div class="pull-right text-right">
                                    <hr>
                                    <h3 class="pl-4 mb-2"><strong>Total:&nbsp;</strong><span >RS </span><span id="sell-total"></span></h3>
                                    <h6 class="pl-4"><strong>Amount Paid:&nbsp;</strong><span >RS </span><span id="amount-paid"></span></h6>
                                    <h6 class="pl-4"><strong>Remaining Balance:&nbsp;</strong><span >RS </span><span id="paid-balance"></span></h6>
                                    <h6 class="pl-4"><strong>Change:&nbsp;</strong><span >RS </span><span id="paid-change"></span></h6>
                                    <hr>
                                </div>
                ...
                <div class="col-md-8 payment-input">
                    <div class="payment-input-scroll d-block">
                        <div class="cart-total py-3">
                            ...
                            <h1><span >RS </span><span class="payment-total"></span></h1>
                        </div>
                                                            ...
                                                            <div class='summary d-none clearfix'>
                                                                <div class='line'>
                                                                    <div class='entry total'>
                                                                        ...
                                                                        <span class='pr-1'><span>RS </span></span><span
                                                                ...
                                                                @foreach($products as $product)
                                                                    <div class="product" id="p-{{ $product->batch_id }}"
                                                                        ...
                                                                        <div class="product-img">
                                                                            ...
                                                                            <strong>
                                                                                <span>RS </span><span class="price">{{ $product->retail_price }}</span>
                                                                            </strong>
                                                                        </span>
                                                                        </div>
    ...
    $(document).ready(function () {
        ...
        $(".sell-button").click(function () {
            ...
            jqxhr.done(function (response, textStatus, jqXHR) {
                ...
                var _address = 'Mian Singh Stop, Main Barki Road, Lahore';
                var _contact = '0322-4318325';
        ...
        $("#print").click(function() {
            ...
            $(".printableAreaR").printArea(options);
        });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(variations, function(k, v) {
                    ...
                    html += "<span class=\"price-tag\"><strong><span>RS </span>" +
                ...
                $.each(response, function (k, v) {
                    for (var key in v) {
                        ...
                        cart_item += "<li class='order-line'><span class='product-name'>" +
                            v[key].name + "</span><span class='price'><span>RS </span><span class='price-value'>"
                            ...
                            + "<span>RS </span><span class='price-value'>" + v[key].price + "</span>"
                            + "</li></ul></li></ul>";
